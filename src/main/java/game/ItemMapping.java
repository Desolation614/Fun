...
public enum ItemMapping {
    ...
    ITEM_DRAGON_PICKAXE(11920, 12797, 23677, 25376, 30351),
    ITEM_DRAGON_PICKAXE_OR(23908, 23677),
    ITEM_DRAGON_AXE(6739, 25378, 30352),
    ITEM_DRAGON_HARPOON(21028, 25373, 30349),
    ITEM_INFERNAL_PICKAXE_OR(13243, 25063, 30345),
    ITEM_INFERNAL_PICKAXE_OR_UNCHARGED(13244, 25369, 30346),
    ITEM_INFERNAL_AXE_OR(13241, 25066, 30347),
    ITEM_INFERNAL_AXE_OR_UNCHARGED(13242, 25371, 30348),
    ITEM_INFERNAL_HARPOON_OR(21031, 25059, 30342),
    ITEM_INFERNAL_HARPOON_OR_UNCHARGED(21033, 25367, 30343),
    ITEM_TRAILBLAZER_TOOL_ORNAMENT_KIT(25090, 25376, 30351, 25378, 25373, 25063, 25066, 25059, 30342, 25369, 30346, 25371, 30348, 25367, 30343),
    ...
    ITEM_TORMENTED_SYNAPSE(29580, 29589, 29591, 29594),
    ...
    ITEM_OATHPLATE_HELM(30750, 30777),
    ITEM_OATHPLATE_BODY(30753, 30779),
    ITEM_OATHPLATE_LEGS(30756, 30781),
