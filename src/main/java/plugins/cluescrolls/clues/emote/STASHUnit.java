...
public enum STASHUnit {
    ...
    EMIRS_ARENA_TICKET_OFFICE(28982, new WorldPoint(3316, 3242, 0)),
    ...
    NORTH_OF_EVIL_DAVES_HOUSE_IN_EDGEVILLE(29005, new WorldPoint(3080, 3513, 0)),
    ...
    EAST_OF_THE_LEVEL_19_WILDERNESS_OBELISK(29009, new WorldPoint(3243, 3662, 0)),
    ...
    FORTIS_GRAND_MUSEUM(50738, new WorldPoint(1723, 3153, 0)),
    TEMPLE_SOUTHEAST_OF_THE_BAZAAR(50739, new WorldPoint(1702, 3079, 0)),
    CAM_TORUM_ENTRANCE(50740, new WorldPoint(1428, 3118, 0)),
    WESTERN_SALVAGER_OVERLOOK(54275, new WorldPoint(1614, 3296, 0)),
    TWILIGHT_TEMPLE_MINE(55403, new WorldPoint(1668, 3287, 0)),
    ORTUS_MEETS_PROUDSPIRE(55404, new WorldPoint(1629, 3239, 0)),
    OUTSIDE_TWILIGHT_TEMPLE(55405, new WorldPoint(1693, 3243, 0));
