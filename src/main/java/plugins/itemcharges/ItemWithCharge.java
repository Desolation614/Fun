...
enum ItemWithCharge {
    ...
    AGILITY_MIX_1(ItemChargeType.POTION, 11463, 1),
    AGILITY_MIX_2(ItemChargeType.POTION, 11461, 2),
    ...
    ANTI_MIX1(ItemChargeType.POTION, 11435, 1),
    ANTI_MIX2(ItemChargeType.POTION, 11433, 2),
    ...
    ANTIDOTE_P_MIX1(ItemChargeType.POTION, 11503, 1),
    ANTIDOTE_P_MIX2(ItemChargeType.POTION, 11501, 2),
    ...
    ANCIENT_MIX_1(ItemChargeType.POTION, 26353, 1),
    ANCIENT_MIX_2(ItemChargeType.POTION, 26350, 2),
    ...
    ANTIFIRE_MIX_1(ItemChargeType.POTION, 11507, 1),
    ANTIFIRE_MIX_2(ItemChargeType.POTION, 11505, 2),
    ...
    ATTACK_MIX_1(ItemChargeType.POTION, 11431, 1),
    ATTACK_MIX_2(ItemChargeType.POTION, 11429, 2),
    ...
    BLACK_WARLOCK_MIX1(ItemChargeType.POTION, 29207, 1),
    BLACK_WARLOCK_MIX2(ItemChargeType.POTION, 29189, 2),
    ...
    COMBAT_MIX_1(ItemChargeType.POTION, 11447, 1),
    COMBAT_MIX_2(ItemChargeType.POTION, 11445, 2),
    ...
    DEFENCE_MIX_1(ItemChargeType.POTION, 11459, 1),
    DEFENCE_MIX_2(ItemChargeType.POTION, 11457, 2),
    ...
    EGNIOL1(ItemChargeType.POTION, 23882, 1),
    EGNIOL2(ItemChargeType.POTION, 23883, 2),
    EGNIOL3(ItemChargeType.POTION, 23884, 3),
    EGNIOL4(ItemChargeType.POTION, 23885, 4),
    ...
    ENERGY_MIX_1(ItemChargeType.POTION, 11455, 1),
    ENERGY_MIX_2(ItemChargeType.POTION, 11453, 2),
    ...
    EXTENDED_ANTIFIRE_MIX_1(ItemChargeType.POTION, 11962, 1),
    EXTENDED_ANTIFIRE_MIX_2(ItemChargeType.POTION, 11960, 2),
    ...
    EXTENDED_SUPER_ANTIFIRE_MIX_1(ItemChargeType.POTION, 22224, 1),
    EXTENDED_SUPER_ANTIFIRE_MIX_2(ItemChargeType.POTION, 22221, 2),
    ...
    FISHING_MIX_1(ItemChargeType.POTION, 11479, 1),
    FISHING_MIX_2(ItemChargeType.POTION, 11477, 2),
    ...
    HUNTING_MIX_1(ItemChargeType.POTION, 11519, 1),
    HUNTING_MIX_2(ItemChargeType.POTION, 11517, 2),
    ...
    MAGIC_MIX_1(ItemChargeType.POTION, 11515, 1),
    MAGIC_MIX_2(ItemChargeType.POTION, 11513, 2),
    ...
    MAGIC_ESSENCE_MIX_1(ItemChargeType.POTION, 11491, 1),
    MAGIC_ESSENCE_MIX_2(ItemChargeType.POTION, 11489, 2),
    MOONLIGHT1(ItemChargeType.POTION, 29083, 1),
    MOONLIGHT2(ItemChargeType.POTION, 29082, 2),
    MOONLIGHT3(ItemChargeType.POTION, 29081, 3),
    MOONLIGHT4(ItemChargeType.POTION, 29080, 4),
    MOONLIGHT_MOTH_MIX1(ItemChargeType.POTION, 29213, 1),
    MOONLIGHT_MOTH_MIX2(ItemChargeType.POTION, 29195, 2),
    ...
    PRAYER_MIX_1(ItemChargeType.POTION, 11467, 1),
    PRAYER_MIX_2(ItemChargeType.POTION, 11465, 2),
    ...
    RANGING_MIX_1(ItemChargeType.POTION, 11511, 1),
    RANGING_MIX_2(ItemChargeType.POTION, 11509, 2),
    ...
    RELICYMS_MIX_1(ItemChargeType.POTION, 11439, 1),
    RELICYMS_MIX_2(ItemChargeType.POTION, 11437, 2),
    ...
    RESTORE_MIX_1(ItemChargeType.POTION, 11451, 1),
    RESTORE_MIX_2(ItemChargeType.POTION, 11449, 2),
    ...
    RUBY_HARVEST_MIX1(ItemChargeType.POTION, 29204, 1),
    RUBY_HARVEST_MIX2(ItemChargeType.POTION, 29186, 2),
    ...
    SAPPHIRE_GLACIALIS_MIX1(ItemChargeType.POTION, 29198, 1),
    SAPPHIRE_GLACIALIS_MIX2(ItemChargeType.POTION, 29180, 2),
    ...
    SNOWY_KNIGHT_MIX1(ItemChargeType.POTION, 29201, 1),
    SNOWY_KNIGHT_MIX2(ItemChargeType.POTION, 29183, 2),
    ...
    STAMINA_MIX_1(ItemChargeType.POTION, 12635, 1),
    STAMINA_MIX_2(ItemChargeType.POTION, 12633, 2),
    ...
    STRENGTH_MIX_1(ItemChargeType.POTION, 11441, 1),
    STRENGTH_MIX_2(ItemChargeType.POTION, 11443, 2),
    SUNLIGHT_MOTH_MIX1(ItemChargeType.POTION, 29210, 1),
    SUNLIGHT_MOTH_MIX2(ItemChargeType.POTION, 29192, 2),
    ...
    ANTIPOISON_SUPERMIX_1(ItemChargeType.POTION, 11475, 1),
    ANTIPOISON_SUPERMIX_2(ItemChargeType.POTION, 11473, 2),
    ...
    SUPER_ANTIFIRE_MIX_1(ItemChargeType.POTION, 21997, 1),
    SUPER_ANTIFIRE_MIX_2(ItemChargeType.POTION, 21994, 2),
    ...
    SUPER_ATTACK_MIX1(ItemChargeType.POTION, 11471, 1),
    SUPER_ATTACK_MIX2(ItemChargeType.POTION, 11469, 2),
    ...
    SUPER_DEF_MIX_1(ItemChargeType.POTION, 11499, 1),
    SUPER_DEF_MIX_2(ItemChargeType.POTION, 11497, 2),
    ...
    SUPER_ENERGY_MIX_1(ItemChargeType.POTION, 11483, 1),
    SUPER_ENERGY_MIX_2(ItemChargeType.POTION, 11481, 2),
    ...
    SUPER_RESTORE_MIX_1(ItemChargeType.POTION, 11495, 1),
    SUPER_RESTORE_MIX_2(ItemChargeType.POTION, 11493, 2),
    ...
    SUPER_STR_MIX_1(ItemChargeType.POTION, 11487, 1),
    SUPER_STR_MIX_2(ItemChargeType.POTION, 11485, 2),
    SURGE1(ItemChargeType.POTION, 30884, 1),
    SURGE2(ItemChargeType.POTION, 30881, 2),
    SURGE3(ItemChargeType.POTION, 30878, 3),
    SURGE4(ItemChargeType.POTION, 30875, 4),
    ...
    ZAMORAK_MIX_1(ItemChargeType.POTION, 11523, 1),
    ZAMORAK_MIX_2(ItemChargeType.POTION, 11521, 2),
    ...
    NECTAR1(ItemChargeType.POTION, 27321, 1),
    NECTAR2(ItemChargeType.POTION, 27319, 2),
    NECTAR3(ItemChargeType.POTION, 27317, 3),
    NECTAR4(ItemChargeType.POTION, 27315, 4),
    TEARS_OF_ELIDINIS1(ItemChargeType.POTION, 27333, 1),
    TEARS_OF_ELIDINIS2(ItemChargeType.POTION, 27331, 2),
    TEARS_OF_ELIDINIS3(ItemChargeType.POTION, 27329, 3),
    TEARS_OF_ELIDINIS4(ItemChargeType.POTION, 27327, 4),
    LIQUID_ADRENALINE1(ItemChargeType.POTION, 27341, 1),
    LIQUID_ADRENALINE2(ItemChargeType.POTION, 27339, 2),
    AMBROSIA1(ItemChargeType.POTION, 27349, 1),
    AMBROSI2(ItemChargeType.POTION, 27347, 2),
    BLESSED_CRYSTAL_SCARAB1(ItemChargeType.POTION, 27337, 1),
    BLESSED_CRYSTAL_SCARAB2(ItemChargeType.POTION, 27335, 2),
    SILK_DRESSING1(ItemChargeType.POTION, 27325, 1),
    SILK_DRESSING2(ItemChargeType.POTION, 27323, 2),
    SMELLING_SALTS1(ItemChargeType.POTION, 27345, 1),
    SMELLING_SALTS2(ItemChargeType.POTION, 27343, 2),
    FORGOTTEN_BR1(ItemChargeType.POTION, 27638, 1),
    FORGOTTEN_BR2(ItemChargeType.POTION, 27635, 2),
    FORGOTTEN_BR3(ItemChargeType.POTION, 27632, 3),
    FORGOTTEN_BR4(ItemChargeType.POTION, 27629, 4),
    MENAPHITE_REM1(ItemChargeType.POTION, 27211, 1),
    MENAPHITE_REM2(ItemChargeType.POTION, 27208, 2),
    MENAPHITE_REM3(ItemChargeType.POTION, 27205, 3),
    MENAPHITE_REM4(ItemChargeType.POTION, 27202, 4),
    EXTENDED_ANTI_VENOM1(ItemChargeType.POTION, 29833, 1),
    EXTENDED_ANTI_VENOM2(ItemChargeType.POTION, 29830, 2),
    EXTENDED_ANTI_VENOM3(ItemChargeType.POTION, 29827, 3),
    EXTENDED_ANTI_VENOM4(ItemChargeType.POTION, 29824, 4),
    GOADING1(ItemChargeType.POTION, 30146, 1),
    GOADING2(ItemChargeType.POTION, 30143, 2),
    GOADING3(ItemChargeType.POTION, 30140, 3),
    GOADING4(ItemChargeType.POTION, 30137, 4),
    PRAYER_REGENERATION1(ItemChargeType.POTION, 30134, 1),
    PRAYER_REGENERATION2(ItemChargeType.POTION, 30131, 2),
    PRAYER_REGENERATION3(ItemChargeType.POTION, 30128, 3),
    PRAYER_REGENERATION4(ItemChargeType.POTION, 30125, 4);
