...
enum ItemIdentification {
    ...
    HARRALANDER_SEED(Type.SEED_HERB, "Harra", "HAR", 5294),
    ...
    HUASCA_SEED(Type.SEED_HERB, "Huasca", "HUA", 30088),
    ...
    HARRALANDER(Type.HERB, "Harra", "HAR", 255, 205),
    ...
    HUASCA(Type.HERB, "Huasca", "HUA", 30097, 30094),
    ...
    BLURITE_BAR(Type.BAR, "Blurite", "BLU", 9467),
    ELEMENTAL_METAL(Type.BAR, "Elemental", "ELE", 2893),
    LOVAKITE_BAR(Type.BAR, "Lovakite", "LOV", 13354),
    LUNAR_BAR(Type.BAR, "Lunar", "LUN", 9077),
    ...
    ATTACK_MIX(Type.POTION, "Att", "A", 11431, 11429),
    STRENGTH(Type.POTION, "Str", "S", 113, 115, 117, 119),
    STRENGTH_MIX(Type.POTION, "Str", "S", 11441, 11443),
    DEFENCE(Type.POTION, "Def", "D", 2432, 133, 135, 137),
    DEFENCE_MIX(Type.POTION, "Def", "D", 11459, 11457),
    COMBAT(Type.POTION, "Com", "C", 9739, 9741, 9743, 9745),
    COMBAT_MIX(Type.POTION, "Com", "C", 11447, 11445),
    MAGIC(Type.POTION, "Magic", "M", 3040, 3042, 3044, 3046),
    MAGIC_MIX(Type.POTION, "Magic", "M", 11515, 11513),
    RANGING(Type.POTION, "Range", "R", 2444, 169, 171, 173),
    RANGING_MIX(Type.POTION, "Range", "R", 11511, 11509),
    ...
    SUPER_ATTACK_MIX(Type.POTION, "S.Att", "S.A", 11471, 11469),
    SUPER_STRENGTH(Type.POTION, "S.Str", "S.S", 2440, 157, 159, 161),
    SUPER_STRENGTH_MIX(Type.POTION, "S.Str", "S.S", 11487, 11485),
    SUPER_DEFENCE(Type.POTION, "S.Def", "S.D", 2442, 163, 165, 167),
    SUPER_DEFENCE_MIX(Type.POTION, "S.Def", "S.D", 11499, 11497),
    ...
    RESTORE_MIX(Type.POTION, "Restore", "Re", 11451, 11449),
    GUTHIX_BALANCE(Type.POTION, "GuthBal", "G.B.", 7660, 7662, 7664, 7666),
    SUPER_RESTORE(Type.POTION, "S.Rest", "S.Re", 3024, 3026, 3028, 3030),
    SUPER_RESTORE_MIX(Type.POTION, "S.Rest", "S.Re", 11495, 11493),
    PRAYER(Type.POTION, "Prayer", "P", 2434, 139, 141, 143),
    PRAYER_MIX(Type.POTION, "Prayer", "P", 11467, 11465),
    ENERGY(Type.POTION, "Energy", "En", 3008, 3010, 3012, 3014),
    ENERGY_MIX(Type.POTION, "Energy", "En", 11455, 11453),
    SUPER_ENERGY(Type.POTION, "S.Energ", "S.En", 3016, 3018, 3020, 3022),
    SUPER_ENERGY_MIX(Type.POTION, "S.Energ", "S.En", 11483, 11481),
    STAMINA(Type.POTION, "Stamina", "St", 12625, 12627, 12629, 12631),
    STAMINA_MIX(Type.POTION, "Stamina", "Sta", 12635, 12633),
    OVERLOAD(Type.POTION, "Overloa", "OL", 11730, 11731, 11732, 11733),
    ABSORPTION(Type.POTION, "Absorb", "Ab", 11734, 11735, 11736, 11737),
    BLIGHTED_SUPER_RESTORE(Type.POTION, "BS.Rest", "BS.Re", 24598, 24601, 24603, 24605),
    PRAYER_REGENERATION(Type.POTION, "Pray R.", "P.R.", 30125, 30128, 30131, 30134),
    GOADING(Type.POTION, "Goading", "G", 30137, 30140, 30143, 30146),
    ZAMORAK_BREW(Type.POTION, "ZammyBr", "Za", 2450, 189, 191, 193),
    ZAMORAK_MIX(Type.POTION, "ZammyBr", "Z", 11523, 11521),
    SARADOMIN_BREW(Type.POTION, "SaraBr", "Sa", 6685, 6687, 6689, 6691),
    ANCIENT_BREW(Type.POTION, "AncBr", "A.Br", 26340, 26342, 26344, 26346),
    ANCIENT_MIX(Type.POTION, "AncBr", "Anc", 26353, 26350),
    FORGOTTEN_BREW(Type.POTION, "ForgBr", "F.Br", 27629, 27632, 27635, 27638),
    ANTIPOISON(Type.POTION, "AntiP", "AP", 2446, 175, 177, 179),
    ANTIPOISON_MIX(Type.POTION, "AntiP", "AP", 11435, 11433),
    SUPERANTIPOISON(Type.POTION, "S.AntiP", "S.AP", 2448, 181, 183, 185),
    ANTIPOISON_SUPERMIX(Type.POTION, "S.AntiP", "S.AP", 11475, 11473),
    ANTIDOTE_P(Type.POTION, "Antid+", "A+", 5943, 5945, 5947, 5949),
    ANTIDOTE_P_MIX(Type.POTION, "Antid+", "A+", 11503, 11501),
    ...
    EXT_ANTIVENOM_P(Type.POTION, "E.AntiV+", "EAV+", 29824, 29827, 29830, 29833),
    RELICYMS_BALM(Type.POTION, "Relicym", "R.B", 4842, 4844, 4846, 4848),
    RELICYMS_MIX(Type.POTION, "Relicym", "R.B", 11439, 11437),
    SANFEW_SERUM(Type.POTION, "Sanfew", "Sf", 10925, 10927, 10929, 10931),
    ANTIFIRE(Type.POTION, "Antif", "Af", 2452, 2454, 2456, 2458),
    ANTIFIRE_MIX(Type.POTION, "Antif", "Af", 11507, 11505),
    EXTENDED_ANTIFIRE(Type.POTION, "E.Antif", "E.Af", 11951, 11953, 11955, 11957),
    EXTENDED_ANTIFIRE_MIX(Type.POTION, "E.Antif", "E.Af", 11962, 11960),
    SUPER_ANTIFIRE(Type.POTION, "S.Antif", "S.Af", 21978, 21981, 21984, 21987),
    SUPER_ANTIFIRE_MIX(Type.POTION, "S.Antif", "S.Af", 21997, 21994),
    EXTENDED_SUPER_ANTIFIRE(Type.POTION, "ES.Antif", "ES.Af", 22209, 22212, 22215, 22218),
    EXTENDED_SUPER_ANTIFIRE_MIX(Type.POTION, "ES.Antif", "ES.Af", 22224, 22221),
    SERUM_207(Type.POTION, "Ser207", "S7", 3408, 3410, 3412, 3414),
    SERUM_208(Type.POTION, "Ser208", "S8", 3416, 3417, 3418, 3419),
    SACRED_OIL(Type.POTION, "SaOil", "SO", 3430, 3432, 3434, 3436),
    OLIVE_OIL(Type.POTION, "Olive", "Oli", 3422, 3424, 3426, 3428),
    COMPOST_POTION(Type.POTION, "Compost", "COM", 6470, 6472, 6474, 6476),
    AGILITY(Type.POTION, "Agility", "Ag", 3032, 3034, 3036, 3038),
    AGILITY_MIX(Type.POTION, "Agility", "Ag", 11463, 11461),
    FISHING(Type.POTION, "Fishing", "Fi", 2438, 151, 153, 155),
    FISHING_MIX(Type.POTION, "Fishing", "Fi", 11479, 11477),
    HUNTER(Type.POTION, "Hunter", "Hu", 9998, 10000, 10002, 10004),
    HUNTING_MIX(Type.POTION, "Hunter", "Hu", 11519, 11517),
    GOBLIN(Type.POTION, "Goblin", "G", 26581, 26583, 26585, 26587),
    MAGIC_ESS(Type.POTION, "MagEss", "M.E", 9021, 9022, 9023, 9024),
    MAGIC_ESSENCE_MIX(Type.POTION, "MagEss", "M.E", 11491, 11489),
    REJUVENATION(Type.POTION, "Rejuv", "Rj", 20699, 20700, 20701, 20702),
    ELDER(Type.POTION, "Elder", "El", 20916, 20915, 20914, 20913, 20920, 20919, 20918, 20917, 20924, 20923, 20922, 20921),
    TWISTED(Type.POTION, "Twisted", "Tw", 20928, 20927, 20926, 20925, 20932, 20931, 20930, 20929, 20936, 20935, 20934, 20933),
    KODAI(Type.POTION, "Kodai", "Ko", 20940, 20939, 20938, 20937, 20944, 20943, 20942, 20941, 20948, 20947, 20946, 20945),
    ANTIPOISON_COX(Type.POTION, "AntiP", "AP", 25757, 25756, 25755, 25754, 25761, 25760, 25759, 25758, 25765, 25764, 25763, 25762),
    REVITALISATION(Type.POTION, "Revit", "Re", 20952, 20951, 20950, 20949, 20956, 20955, 20954, 20953, 20960, 20959, 20958, 20957),
    PRAYER_ENHANCE(Type.POTION, "P.Enh", "Enh", 20964, 20963, 20962, 20961, 20968, 20967, 20966, 20965, 20972, 20971, 20970, 20969),
    XERICS_AID(Type.POTION, "X.Aid", "Aid", 20976, 20975, 20974, 20973, 20980, 20979, 20978, 20977, 20984, 20983, 20982, 20981),
    OVERLOAD_COX(Type.POTION, "Overloa", "Ovl", 20988, 20987, 20986, 20985, 20992, 20991, 20990, 20989, 20996, 20995, 20994, 20993),
    NECTAR(Type.POTION, "Nectar", "N", 27315, 27317, 27319, 27321),
    AMBROSIA(Type.POTION, "Ambros", "A", 27347, 27349),
    LIQUID_ADRENALINE(Type.POTION, "L.Adrn", "L.A", 27339, 27341),
    TEARS_OF_ELIDINIS(Type.POTION, "Tears", "ToE", 27327, 27329, 27331, 27333),
    MENAPHITE_REMEDY(Type.POTION, "MenRem", "M.R", 27202, 27205, 27208, 27211),
    MOONLIGHT_POTION(Type.POTION, "Moon", "M", 29083, 29082, 29081, 29080),
    GUAM_POTION(Type.POTION, "Guam", "G", 91),
    MARRENTILL_POTION(Type.POTION, "Marren", "M", 93),
    TARROMIN_POTION(Type.POTION, "Tarro", "TAR", 95),
    HARRALANDER_POTION(Type.POTION, "Harra", "HAR", 97),
    ...
    HUASCA_POTION(Type.POTION, "Huasca", "HUA", 30100),
    BLACK_WARLOCK(Type.BUTTERFLY_MOTH_JAR, "B.War", "BW", 10014),
    MOONLIGHT_MOTH(Type.BUTTERFLY_MOTH_JAR, "Moon", "M", 28893),
    RUBY_HARVEST(Type.BUTTERFLY_MOTH_JAR, "Ruby.H", "RH", 10020),
    SAPPHIRE_GLACIALIS(Type.BUTTERFLY_MOTH_JAR, "Saph.G", "SG", 10018),
    SNOWY_KNIGHT(Type.BUTTERFLY_MOTH_JAR, "Snow.K", "SK", 10016),
    SUNLIGHT_MOTH(Type.BUTTERFLY_MOTH_JAR, "Sun", "S", 28890),
    BLACK_WARLOCK_MIX(Type.BUTTERFLY_MOTH_JAR, "B.War x", "BW x", 29207, 29189),
    MOONLIGHT_MOTH_MIX(Type.BUTTERFLY_MOTH_JAR, "Moon x", "M x", 29213, 29195),
    RUBY_HARVEST_MIX(Type.BUTTERFLY_MOTH_JAR, "Ruby.H x", "RH x", 29204, 29186),
    SAPPHIRE_GLACIALIS_MIX(Type.BUTTERFLY_MOTH_JAR, "Saph.G x", "SG x", 29198, 29180),
    SNOWY_KNIGHT_MIX(Type.BUTTERFLY_MOTH_JAR, "Snow.K x", "SK x", 29201, 29183),
    SUNLIGHT_MOTH_MIX(Type.BUTTERFLY_MOTH_JAR, "Sun x", "S x", 29210, 29192),
    ...
    KOUREND_CASTLE_TELEPORT(Type.TABLET, "K.Cast", "KOU", 28790),
    CIVITAS_ILLA_FORTIS_TELEPORT(Type.TABLET, "Civitas", "CIV", 28824),
    ...
    CARRALLANGER_TELEPORT(Type.TABLET, "Carra", "CAR", 12776),
    ...
    JUG_OF_WATER(Type.WINES, "Water", "Wat", 1937),
    UNFERMENTED_WINE(Type.WINES, "Unf.", "U", 1995),
    ZAMORAKS_UNFERMENTED_WINE(Type.WINES, "Unf. Z", "UZ", 20752),
    JUG_OF_WINE(Type.WINES, "Wine", "W", 1993),
    WINE_OF_ZAMORAK(Type.WINES, "Zammy", "Z", 245),
    JUG_OF_BAD_WINE(Type.WINES, "Bad", "Bad", 1991),
    HALF_FULL_WINE_JUG(Type.WINES, "Half", "HF", 1989),
    JUG_OF_BLESSED_WINE(Type.WINES, "Blessed", "B", 29386),
    JUG_OF_SUNFIRE_WINE(Type.WINES, "Sunfire", "S", 29382),
    JUG_OF_BLESSED_SUNFIRE_WINE(Type.WINES, "B. Sun", "BS", 29384);
