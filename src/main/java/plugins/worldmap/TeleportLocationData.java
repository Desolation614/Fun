...
enum TeleportLocationData {
    ...
    private TeleportLocationData(TeleportType type, String destination, int magicLevel, WorldPoint location, String iconPath) {
        this.type = type;
    ...
    private TeleportLocationData(TeleportType type, String item, String destination, WorldPoint location, String iconPath) {
        this.type = type;
    ...
    private TeleportLocationData(TeleportType type, String item, WorldPoint location, String iconPath) {
        this.type = type;
        this.tooltip = item;
        this.location = location;
        this.iconPath = iconPath;
