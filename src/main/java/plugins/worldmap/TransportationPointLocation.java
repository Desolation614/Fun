...
enum TransportationPointLocation {
    ...
    private TransportationPointLocation(String tooltip, WorldPoint worldPoint) {
    ...
    private TransportationPointLocation(@Nullable String tooltip, WorldPoint location, WorldPoint target) {
