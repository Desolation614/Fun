...
enum HunterAreaLocation {
    ...
    FALCONRY(new WorldPoint(2379, 3599, 0), HunterCreature.SPOTTED_KEBBIT, HunterCreature.DARK_KEBBIT, HunterCreature.DASHING_KEBBIT),
    ...
    MONS_GRATIA(new WorldPoint(1443, 3235, 0), HunterCreature.CERULEAN_TWITCH, HunterCreature.SNOWY_KNIGHT, HunterCreature.SAPPHIRE_GLACIALIS),
