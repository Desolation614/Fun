...
enum VarrockMuseumAnswer {
    ...
    static Widget findCorrect(Client client, String question, int ... widgets) {
        String s = MATCHES.get(question);
        for (int widgetInfo : widgets) {
            Widget widget = client.getWidget(widgetInfo);
            if (widget == null || !widget.getText().equals(s)) continue;
            return widget;
        }
        return null;
    }
    ...
    private VarrockMuseumAnswer(String question, String answer) {
    ...
    static {
        ...
        for (VarrockMuseumAnswer varrockMuseumAnswer : VarrockMuseumAnswer.values()) {
            builder.put((Object)varrockMuseumAnswer.question, (Object)varrockMuseumAnswer.answer);
        }
