...
public enum JreDeflateParameters {
    ...
    public static JreDeflateParameters parseString(String input) {
        ...
        return JreDeflateParameters.of(Integer.parseInt(parts[0].split("=")[1]), Integer.parseInt(parts[1].split("=")[1]), Boolean.parseBoolean(parts[2].split("=")[1]));
    }
